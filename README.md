...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/checklist-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11530&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/checklist-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `checklist` can be installed with:

```
conda install checklist
```

It is possible to list all of the versions of `checklist` available on your platform with:
